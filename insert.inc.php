...
if (isset($_POST['insert-product'])) {
    ...
    $sql = "INSERT INTO product (product_name, vehicle_type, cover_type, product_price, product_description) VALUES ('$product_name','$vehicle_type','$cover_type','$product_price','$product_description')";
    if (mysqli_query($conn, $sql)) {
